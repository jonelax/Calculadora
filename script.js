        ...
        btns[i].addEventListener('click', function () {
            ...
            switch (btnValue) {
                ...
                case '=':
                    ...
                    // Remplaza x por *, + por / para que se calculado en eval
                    input = input.replace(/x/g, '*').replace(/÷/g, '/');

                    // Checkeando ultimo caracter del input.
                ...
                case '÷':
                    // Last char of string
                    var lastChar = input[input.length - 1];
                    // Solo añade operador si el input no esta vacio y no hay operador al final
                    if(input != '' && operators.indexOf(lastChar) == -1)
                        inputScreen.innerHTML += btnValue;
                    // Permite poner menos si el input esta vacio. Permite uso de números negativos
